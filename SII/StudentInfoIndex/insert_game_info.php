        ...
        $(document).ready(function () {
            $('.add_field').click(function (e) {
                ...
                $('.input_area').append('<div style="margin-top: 20px">' +
                        '<label>Game Nmae:</label>'+
                        '<input type="name" name="gamename[]">'+
...
<body>
    ...
    <section id="contentt">
     <div id="banner">
      ...
      <div class="inside">
       <li><a href="game_info.php">Return Game Info</a></li>
       <h2> Insert Game Info</h2>
        <form action="insert_game_info.2.php" method="post">
