...
<form name="frmUserHall" action="" method="post">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th width="720">Game Name</th>
                                    
                                </tr>
                            </thead>
                            <tbody>
                              	<?php 
                                $q="SELECT * FROM `game_info` order by `game_id` asc";
    ...
    for(var i = 1, td; i < rows.length; i++){
        ...
        rows[i].insertBefore(td, rows[i].firstChild);
						...
						<button class="btn btn-success"  name="submit_mult" type="submit" onclick="editGameInfo();">
                           
                       UPDATE
                        </button>
                      <!--  <button class="btn btn-success"  name="submit_dlt" type="submit" onclick="deleteGameInfo();">
                        Delete
                        </button>
                        -->
...
<div id="header">
             ...
             <a href="insert_game_info.php">Insert Game Info</a></li>
