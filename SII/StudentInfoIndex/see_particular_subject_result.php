...
<div class="wrap">
  ...
  <div class="container">
    ...
    <section id="content">
      ...
      <div class="inside">
        <h2><span>Select The Course ID For finding Result</span></h2>
        
      
        <form id="contacts-form" action="see_particular_course_result2.php" method="post" >
          <fieldset>
          <div class="field">
