...
<strong><i class="icon-user icon-large"></i>&nbsp;Multiple Checking</strong>&nbsp;check first the radio button the data you want to edit or delete
                            </div>
                            <thead>
                                <tr>
                                    <th width="30">SL</th>
			...
			<button class="btn btn-success"  name="submit_mult" type="submit" onclick="editDistrictinfo();">
...
<div id="header">
             ...
             <a href="insert_district1.php">Insert District Info</a></li>
