...
<br><br>
<form name="frmUser" action="edit_contest_info.php" method="post">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th width="720">Contest Name</th>
                                    
                                </tr>
                            </thead>
                            <tbody>
                              	<?php 
                                $q="SELECT * FROM `contest_info` ORDER BY `contest_id` ASC";
...
<div id="header">
             ...
             <a href="insert_contest_info.1.php">Insert Contest Info</a></li>
