        ...
        $(document).ready(function () {
            $('.add_field').click(function (e) {
                ...
                $('.input_area').append('<div style="margin-top: 20px">' +
                        ...
                        '<input type="name" name="districtname[]">'+
...
<body>
    ...
    <section id="contentt">
      ...
      <div class="inside">
       <li><a href="district_info.php">Return District  Info</a></li>
        <h2> Insert District Info</h2>
        <br>
        <br>



        <form action="insert_district2.php" method="post">
